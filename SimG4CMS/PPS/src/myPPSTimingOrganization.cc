...
myPPSTimingOrganization :: ~myPPSTimingOrganization()
{
}


uint32_t myPPSTimingOrganization::GetUnitID(const G4Step* aStep) const
{
  return const_cast<myPPSTimingOrganization *>(this)->GetUnitID(aStep);
}


uint32_t myPPSTimingOrganization::GetUnitID(const G4Step* aStep)
{
