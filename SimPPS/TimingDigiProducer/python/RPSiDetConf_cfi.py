...
RPTimingDigitizer = cms.EDProducer("RPTimingDigiProducer",
    ...
    RPPhotoElectronTOF = cms.double(1.5),
    RPPhotoElectronTTS = cms.double(0.25),

    # RPAmplitudeCal
    RPPhotonReflectionEfficiency = cms.double(0.8),
    RPPhotomultiplierGain = cms.double(1000.0),
    RPPhotonAmplRes = cms.double(0.3),
