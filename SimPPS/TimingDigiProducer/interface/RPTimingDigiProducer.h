#ifndef SimPPS_TimingDigiProducer_RPTimingDigiProducer_h
#define SimPPS_TimingDigiProducer_RPTimingDigiProducer_h
...
class RPTimingDigiProducer : public edm::EDProducer {
   public:
      explicit RPTimingDigiProducer(const edm::ParameterSet&);
      ~RPTimingDigiProducer();
...
//      std::map<RPDetId, boost::shared_ptr<RPDetDigitizer> > theAlgoMap;
      std::map<TimingId, boost::shared_ptr<RPDetDigitizer> > theAlgoMap;
      //std::vector<edm::DetSet<RPStripDigi> > theDigiVector;
      std::vector<edm::DetSet<RPLBarDigi> > theDigiVector;
 //     std::vector<edm::DetSet<RPDetTrigger> > theTriggerVector;
      std::vector<edm::DetSet<RPTimingTrigger> > theTriggerVector;
