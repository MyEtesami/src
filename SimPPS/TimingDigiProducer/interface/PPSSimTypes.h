#ifndef SimTotem_RPDigiProducer_PPSSimTypes_H
#define SimTotem_RPDigiProducer_PPSSimTypes_H
...
namespace SimPPSTiming
{
  typedef std::vector<double> PhotoElectron_ArrTime_vec;
  typedef std::map<int, std::vector<double> > PhotoElectron_ArrTime_map_links_type;
  typedef std::vector<std::vector<double> > TimingDigiPrimaryMapType; //for each digi in the output the vector of the number of PSimHit and its weight
  typedef std::map<unsigned short, std::vector<double> > TimingTriggerContainerLinkMap; //for each strip the indeces of PSimHit and amounts of charge generated by it is given
  typedef std::vector<std::vector<double> > TimingTriggerPrimaryMapType; //for each digi in the output the vector of the number of PSimHit and its weight
...
#endif  //SimPPS_TimingDigiProducer_PPSSimTypes_H
