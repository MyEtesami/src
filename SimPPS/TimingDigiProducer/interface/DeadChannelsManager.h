#ifndef SimPPS_TimingDigiProducer_DEAD_CHANNELS_MANAGER
#define SimPPS_TimingDigiProducer_DEAD_CHANNELS_MANAGER
...
//	bool isChannelDead(RPDetId detectorId, unsigned short stripNumber);
        bool isChannelDead(TimingId detectorId, unsigned short stripNumber);	
	void displayMap();
};
