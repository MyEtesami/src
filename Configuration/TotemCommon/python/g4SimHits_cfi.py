...
#        )
    ...
    StackingAction = cms.PSet(
        ...
        SaveFirstLevelSecondary = cms.untracked.bool(False), # HINT: TOTEM uses True, CMS uses False
    ...
    PPS_Timing_SD = cms.PSet( # HINT: TOTEM specific
        Verbosity = cms.int32(0),
        MaterialPropertiesDebugLevel=cms.int32(3)
    ),
