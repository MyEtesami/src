#ifndef DataFormats_RPTimingDataTypes_RP_LBARDIGI_H
#define DataFormats_RPTimingDataTypes_RP_LBARDIGI_H


#include "DataFormats/TotemRPDataTypes/interface/RPTypes.h"
//#include "DataFormats/RPTimingDataTypes/interface/PPSTimingTypes.h"
//#include "DataFormats/PPSDetId/interface/PPSTimingDetId.h"

class RPLBarDigi {
 public:
  RPLBarDigi (RPDetId det_id=0,// unsigned short lbar_no=0, 
    double leadingTime =-1, double trailingTime=-1, unsigned short strip_no=0)
    {
      det_id_=det_id; 
      strip_no_=strip_no;
