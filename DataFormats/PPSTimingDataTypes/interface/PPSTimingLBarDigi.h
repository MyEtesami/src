#ifndef DataFormats_PPSTimingDataTypes_PPSTiming_LBARDIGI_H
#define DataFormats_PPSTimingDataTypes_PPSTiming_LBARDIGI_H
...
//    RPLBarDigi (TimingId det_id=0, double leadingTime =-1, double trailingTime=-1, unsigned short strip_no=0)
    PPSTimingLBarDigi (TimingId det_id=0, double leadingTime =-1, double trailingTime=-1)
    {
      det_id_=det_id; 
//      strip_no_=strip_no;
...
inline bool operator<( const PPSTimingLBarDigi& one, const PPSTimingLBarDigi& other) {
