...
#                               'Geometry/ForwardCommonData/data/forward.xml'
                               ...
                               'Geometry/XMLTutorial/data/RP_Timing_Lbar.xml',
                               'Geometry/XMLTutorial/data/RP_Timing_Box_Left.xml',
                               'Geometry/XMLTutorial/data/RP_Timing_Box_Right.xml',
                               'Geometry/XMLTutorial/data/RP_215_Left_Detector_Assembly.xml',
                               'Geometry/XMLTutorial/data/RP_215_Right_Detector_Assembly.xml',
